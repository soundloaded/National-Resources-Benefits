...
use App\Filament\Clusters\SupportTicket\Resources\PendingTicketResource\Pages;
use App\Filament\Clusters\SupportTicket\Resources\PendingTicketResource\RelationManagers;
...
class PendingTicketResource extends Resource
{
    protected static ?string $model = SupportTicketModel::class;

    protected static ?string $navigationIcon = 'heroicon-o-clock';
    protected static ?string $navigationLabel = 'Pending Ticket';
    ...
    {
        return [
            'index' => Pages\ListPendingTickets::route('/'),
        ];
    }
}
