...
use App\Filament\Clusters\SupportTicket\Resources\ClosedTicketResource\Pages;
use App\Filament\Clusters\SupportTicket\Resources\ClosedTicketResource\RelationManagers;
...
class ClosedTicketResource extends Resource
{
    protected static ?string $model = SupportTicketModel::class;

    protected static ?string $navigationIcon = 'heroicon-o-check-circle';
    protected static ?string $navigationLabel = 'Close Ticket';
    ...
    {
        return parent::getEloquentQuery()->where('status', 'closed');
    }
    ...
    {
        return [
            'index' => Pages\ListClosedTickets::route('/'),
        ];
    }
}
